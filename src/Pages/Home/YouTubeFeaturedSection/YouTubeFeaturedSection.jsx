...
const AnimatedText = () => {
  ...
  return (
    <motion.span
      ...
      className="bg-gradient-to-r from-red-400 via-red-500 to-pink-500 bg-clip-text text-transparent"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-start gap-6 mb-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400 text-sm">Verified Education Channel</span>
              </div>
            </div>
          </div>
          ...
          <motion.a
            ...
            className="w-full inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-full font-bold text-lg shadow-xl relative overflow-hidden group"
            whileHover={{ 
              scale: 1.03,
              boxShadow: "0 0 30px rgba(239, 68, 68, 0.5)"
            }}
          ...
          >
            ...
            />
            <YouTubeIcon className="w-6 h-6 relative z-10" />
            <span className="relative z-10">Subscribe & Learn</span>
