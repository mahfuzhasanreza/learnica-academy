  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 backdrop-blur-xl border border-indigo-500/20 rounded-3xl p-10 max-w-4xl mx-auto shadow-2xl">
            <h3 className="text-3xl font-bold text-white mb-6">
              Need Immediate Help?
            </h3>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              Check out our FAQ section for quick answers to common questions, 
              or schedule a free consultation with our education advisors.
            </p>
            
            <motion.div className="flex flex-col sm:flex-row gap-6 justify-center">
              <motion.button
                className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full font-bold text-lg shadow-xl relative overflow-hidden backdrop-blur-sm border border-white/10"
                whileHover={{ 
                  scale: 1.05,
              ...
              <motion.button
                className="px-8 py-4 border-2 border-purple-500/50 text-white rounded-full font-bold text-lg hover:border-purple-500 hover:bg-purple-500/10 transition-all backdrop-blur-lg shadow-xl"
                whileHover={{ 
                  scale: 1.05,
