...
const WhatsAppIcon = ({ className = "" }) => (
    <svg className={className} viewBox="0 0 448 512" fill="currentColor">
      <path d="M380.9 97.1C339-4.1 221.1-31.6 131.4 29.7c-74.4 50.3-102.5 142.5-67.5 221.1L3.4 480l228.9-60.5c39.8 13.8 83.3 11.7 120.8-5.6 87.9-40.1 124.7-142.4 88.2-228.1zM248.2 371.5c-30.1 0-59.4-8.7-84.5-25.3l-6-3.8-62.9 16.6 16.8-61.5-3.9-6.3c-22.3-35.5-27.5-79.6-13.8-119.6 13.8-40.1 44.5-71.4 84.4-86.1 17.6-6.4 36-9.6 54.3-9.6 30.1 0 59.4 8.7 84.5 25.3 35.7 23.8 58.3 63.3 61.6 107.1 3.3 43.9-12.6 86.8-43.6 118.7-26.6 27.1-62.6 42.4-100.9 42.4z" />
    </svg>
);
